...
public class Maladie {
	...
	public Maladie(int id, Date dateDebut, Date dateFin, int nbrJours, String libelle, int justification,
			Employe employe) {
		super();
		this.id = id;
	...
	public Maladie(Date dateDebut, Date dateFin, int nbrJours, String libelle, int justification, Employe employe) {
		super();
		this.dateDebut = dateDebut;
		this.dateFin = dateFin;
		this.nbrJours = nbrJours;
